...
{
    var f = new FileList(
            FILE.join(SYSTEM.env.CAPP_BUILD, "**/Aristo.blend"),
            FILE.join(SYSTEM.env.CAPP_BUILD, "**/Aristo2.blend"),
            FILE.join(SYSTEM.env.CAPP_BUILD, "**/Aristo3.blend")),
        paths = f.items();

    f = new FileList(
            FILE.join(SYSTEM.env.CAPP_BUILD, "Aristo.build"),
            FILE.join(SYSTEM.env.CAPP_BUILD, "Aristo2.build"),
            FILE.join(SYSTEM.env.CAPP_BUILD, "Aristo3.build"));
